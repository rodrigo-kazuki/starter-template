...
const Testimonial = (props: {
  ...
  const { scope: quoteScope, entranceAnimation: quoteEntranceAnimation, exitAnimation: quoteExitAnimation } = useTextRevelAnimation();
  const { scope: citeScope, entranceAnimation: citeEntranceAnimation, exitAnimation:citeExitAnimation} = useTextRevelAnimation();
  ...
  return (
    <div
      className={twMerge("grid md:grid-cols-6 md:gap-8 lg:gap-16 md:items-center", className)}
      {...rest }
    >
      <div className="aspect-square  md:col-span-3 relative">
      <motion.div
