      ...
      <div className="grid md:grid-cols-12 md:h-screen items-stretch">
        <div className="md:col-span-7 flex flex-col justify-center">
          <div className="container !max-w-full">
            <h1 className="text-5xl md:text-6xl lg:text-7xl mt-40 md:mt-o">Finish Carpentry | Trim | Doors Specialists | Accent Wall, Feature wall and Panels | Construction and renovation.</h1>
        ...
        <div className="md:col-span-5">
          <div className="mt-20 md:mt-0 md:h-full">
            <Image src={heroImage} alt="ACOimage" className="size-full object-cover" />
          </div>
        </div>
      </div>
    </section>
