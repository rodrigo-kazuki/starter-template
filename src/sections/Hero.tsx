        ...
        <div className="md:col-span-7 flex flex-col justify-center">
          <div className="container !max-w-full">
            <motion.h1
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-5xl md:text-6xl lg:text-7xl mt-40 md:mt-o"
              ref={titleScope}>
              Finish Carpentry | Trim | Doors Specialists | Accent Wall, Feature wall and Panels | Construction and renovation.
            </motion.h1>
