...
const Testimonials: FC = () => {
  const testemonialIndex = 0;
  return (
    <section className="section">
      <h2 className="text-4xl md:text-7xl lg:text-8xl flex flex-col over-flow-hidden tracking-lighter">
      ...
      <div className="container">
        <div className="mt-20">{testimonials.map(({ name, company, role, quote, image, imagePositionY }, index) => index === testemonialIndex && (
